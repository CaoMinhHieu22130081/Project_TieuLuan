      ...
      <div className="header-search-panel">
        <div className="header-search-inner">
          <div className="header-search-top">
            ...
            <button className="header-search-close" onClick={onClose} aria-label="Đóng tìm kiếm">
      ...
      <header className={`navbar ${scrolled ? 'scrolled' : ''}`}>
        <div className="nav-inner">
          ...
          <div className="nav-actions">
            <a href="/login" className="btn-secondary" style={{ marginRight: 8 }}>Đăng nhập</a>
            <a href="/register" className="btn-primary" style={{ marginRight: 8 }}>Đăng ký</a>
            ...
            <button className="nav-icon-btn" aria-label="user">
              <svg width="20" height="20" fill="none" viewBox="0 0 24 24">
